-- Fix the auto_apply_late_penalty trigger to use local timezone comparisons
...
BEGIN
  ...
  IF NEW.status = 'completed' 
    ...
    -- Calculate how late the checkout is (in minutes) using LOCAL times for user-friendly comparisons
    -- Compare current time with the local end time (not UTC) so timezone stays consistent
