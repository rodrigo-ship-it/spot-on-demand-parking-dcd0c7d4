          ...
          >
            ...
            <div className="space-y-6 pt-16 md:pt-20">
              ...
              >
                ...
                <span className="block -mt-2 md:-mt-4 min-h-[2rem] md:min-h-[3rem] lg:min-h-[4rem] overflow-visible pb-4">
                  <TypewriterText 
                    words={[
                    ...
                    className="text-2xl md:text-4xl lg:text-5xl tracking-normal bg-gradient-to-r from-slate-700 via-slate-900 to-slate-700 bg-clip-text text-transparent inline-block"
                  />
                </span>
              </motion.h1>
