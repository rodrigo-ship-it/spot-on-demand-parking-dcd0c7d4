          ...
          >
            ...
            <div className="space-y-6 pt-16 md:pt-20">
              ...
              >
                ...
                <span className="block -mt-2 md:-mt-4 h-[4rem] md:h-[5rem] lg:h-[6rem] overflow-visible pb-4">
                  <TypewriterText 
                    words={[
                    ...
                    className="text-2xl md:text-4xl lg:text-5xl tracking-tight bg-gradient-to-r from-slate-700 via-slate-900 to-slate-700 bg-clip-text text-transparent inline-block"
                  />
                </span>
              </motion.h1>
