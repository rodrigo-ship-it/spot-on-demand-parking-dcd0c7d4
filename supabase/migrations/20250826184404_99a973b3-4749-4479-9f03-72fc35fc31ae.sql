-- Add 30-minute grace period to booking end times in overlap calculation
      ...
      IF (hour_val + p_duration_hours) <= 23 THEN
        ...
        WHERE spot_id = p_spot_id
          ...
          AND (
            ...
            -- slot_start < (booking_end + 30 min grace) AND booking_start < slot_end
            slot_start_minutes < (EXTRACT(HOUR FROM end_time) * 60 + EXTRACT(MINUTE FROM end_time) + 30)
            AND
