                  ...
                  <tr>
                    <td style="padding: 40px 30px; text-align: center;">
                      ...
                      <div style="text-align: left; margin-bottom: 24px;">
                        ...
                        <div>
                          <div style="display: flex; align-items: flex-start;">
                            ...
                            <div>
                              <p style="margin: 0 0 4px; color: #333; font-size: 14px; font-weight: 500;">Get paid automatically</p>
                              <p style="margin: 0; color: #666; font-size: 12px;">Your payout will be transferred after the renter completes checkout</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <p style="margin: 24px 0 0; color: #999; font-size: 14px; line-height: 1.4;">
                        ...
                        <br><br>
                        Thank you for hosting with Arriv!
                      </p>
                    </td>
                  </tr>
                </table>
