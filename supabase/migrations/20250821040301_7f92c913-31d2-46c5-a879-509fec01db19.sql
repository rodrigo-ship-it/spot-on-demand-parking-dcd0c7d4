-- Fix penalty amounts to always use $20 maximum base penalty
...
DECLARE
  ...
  base_penalty NUMERIC := 20.00; -- Always $20 maximum base penalty
...
BEGIN
  ...
  IF NEW.status = 'completed' 
    ...
    IF minutes_late >= 180 THEN
      ...
      -- Base penalty is always $20 (no more $50 for repeat offenses)
      base_penalty := 20.00;
