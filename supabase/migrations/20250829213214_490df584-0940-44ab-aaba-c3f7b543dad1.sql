-- Fix the auto_apply_late_penalty function to use consistent UTC time comparisons
...
BEGIN
  ...
  IF NEW.status = 'completed' 
    ...
    -- FIXED: Calculate how late the checkout is using consistent UTC times
    -- Compare current UTC time with the UTC end time
