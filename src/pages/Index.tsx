          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <div className="hidden md:flex items-center space-x-4">
                <Link to="/how-it-works" className="text-gray-600 hover:text-primary transition-colors font-medium px-3 py-2 rounded-lg hover:bg-gray-50">
                  How it Works
                </Link>
                <Link to="/manage-spots" className="text-gray-600 hover:text-primary transition-colors font-medium px-3 py-2 rounded-lg hover:bg-gray-50">
                  My Spots
                </Link>
              </div>
            </div>
