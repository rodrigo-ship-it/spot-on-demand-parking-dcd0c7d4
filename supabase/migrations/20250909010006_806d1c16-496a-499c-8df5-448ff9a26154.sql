-- CRITICAL SECURITY FIXES - Phase 1: RLS Policy Strengthening (Fixed)

-- 1. Fix INSERT policies - Remove USING clauses and keep only WITH CHECK
...
DROP POLICY IF EXISTS "Places are publicly viewable" ON places;
