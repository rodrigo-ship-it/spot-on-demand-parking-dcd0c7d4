-- Update the penalty trigger to use LOCAL times consistently
...
BEGIN
  ...
  IF NEW.status = 'completed' 
    ...
    -- FIXED: Calculate how late the checkout is using LOCAL times consistently
    -- Compare current time with the LOCAL end time (no UTC conversions!)
